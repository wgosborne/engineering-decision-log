...
export interface Decision {
  ...
  id: string; // UUID
  user_id: string; // UUID - Owner of this decision
 ...
 * Omits: id, user_id, date_created, date_updated (auto-generated by server)
 */
export type NewDecision = Omit<Decision, 'id' | 'user_id' | 'date_created' | 'date_updated' | 'search_vector'>;
